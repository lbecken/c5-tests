...
A dictionary-controlled offline English text-to-speech reader.

Paste plain English prose, check every word against CMUdict before anything is
spoken, then generate speech sentence by sentence with a local neural model.
Nothing leaves the machine, and after installation nothing needs the network.

The goal is understandable, reasonably clear English with correct lexical
...
```
Status:     ready
Engine:     kokoro (kokoro-82m)
Ready:      yes
Device:     cpu
Voices:     af_heart, af_bella, am_michael, am_fenrir
Dictionary: cmudict master@2026-07-28
Entries:    126052
```
...
- US English, UTF-8 plain text
- Words made of Latin letters, as found in CMUdict
...
- control characters
- any word that is not in CMUdict and has no override
...
past-tense and verb readings first, and Version 1 does not consult grammar.
